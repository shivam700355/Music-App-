      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.header}>
          ...
          <View style={styles.profileInfo}>
            <Image
              source={{
                uri: 'https://daylogs.in/employee/app-assets/images/profile/8_907.png',
              }}
              style={styles.profileImage}
            />
            <Text style={styles.name}>Shivam Maurya</Text>
            <Text style={styles.email}>smshivam700751@gmail.com</Text>
          </View>
